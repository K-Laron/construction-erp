  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-surface-900 border border-rose-500/30 rounded-3xl p-8 text-center shadow-2xl shadow-rose-900/20">
        ...
        <button
          onClick={() => reset()}
          className="w-full py-3 bg-interactive-600 hover:bg-interactive-500 text-white font-bold rounded-xl flex items-center justify-center gap-2 transition-all btn-hover-fx"
        >
